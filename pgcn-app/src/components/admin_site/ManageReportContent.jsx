                                            ...
                                            <div className="col-12  d-flex flex-column align-items-start body_form">
                                                <div className="body_container">
                                                    ...
                                                    <p>
                                                        ...
                                                        Respectfully referred to {patientFirstName} {patientMiddleName} {patientLastName}, the herein attached approved request of 
                                                        MR./MS. {claimantFirstname} {claimantMiddlename} {claimantLastname} 
                                                        from Purok - {patientPurok}, Barangay {patientBarangay}, {patientMunicipality}, {patientProvince} for hospital bill assistance stated below:

                                                    </p><br/>
                                                    {/* <p>Patient Information </p>
                                                    <br /> 
                                                    <p><b>Patient Name:</b> &nbsp; {patientFirstName} {patientMiddleName} {patientLastName} {patientExtName}</p> 
                                                    <p><b>Address:</b> &nbsp; {patientAddress}</p> 
                                                    <p><b>Hospital:</b> &nbsp; {patientHospital}</p>
                                                    <br /> 
                                                    <p>Claimant Information</p>
                                                    <br /> 
                                                    <p><b>Claimant Name:</b> &nbsp; {claimantFirstname} {claimantMiddlename} {claimantLastname} {claimantExtName}</p> 
                                                    <p><b>Relationship:</b> &nbsp; {claimantRelationship}</p> 
                                                    <p><b>Contact:</b> &nbsp; {claimantContact}</p> 
                                                    <p><b>Amount:</b> &nbsp; PHP {claimantAmount}</p>  */}
